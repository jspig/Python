...
def runCommand(command):
    ...
    if command == '1':
        ...
        target = input("Enter the search string: ") ##This is where the error was known as raw_input.
...
def displayFiles(path): ## I imported the function but it denied opening the file. 
